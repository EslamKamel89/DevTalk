...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\my_projects\vue\DevTalk\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\windows\\my_projects\\vue\\DevTalk\\public\\storage','logging.default','logging.deprecations.channel',
...
'markdown.code_highlighting.enabled','markdown.code_highlighting.theme','markdown.add_anchors_to_headings','markdown.render_anchors_as_links','markdown.commonmark_options',
'markdown.cache_store','markdown.cache_duration','markdown.renderer_class','markdown.extensions','markdown.block_renderers',
'markdown.inline_renderers','markdown.inline_parsers','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'debugbar.queries.explain','home','discussions.show','discussions.store',
'posts.store','posts.update','posts.destroy','profile.edit',
...
'app','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'vendor.pagination.simple-bootstrap-5','vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','laravel-exceptions-renderer::components.card',
...
'laravel-exceptions::500','laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','markdown::markdown',
